...
public class ClientPanel extends JPanel implements Listener {
	...
	public void listen(String msg) {
		...
		if(msg.contains(MessageConstants.ALL_READY)) {
			...
			System.out.println("ALL READY recieved");
			gameManager.setUp(
					mName, 
					numPlaying,
			...
			//gamePanel.setGlassPaneVisibility(true);
			
			if(gameManager.isMainPlayerTurn())
			{
				new DJ("your_turn");
			}
...
//		if(msg.contains(MessageConstants.STOP_TIMER)) {
//			System.out.println("Receiving notification to stop timer!");
//			gamePanel.stopTimer();
//		}
	}
